<template>
  ...
  <div class="nirf-container md:w-[60%] w-full ">
    <div class="nirf-header">
      ...
      <h2 class="md:text-2xl font-bold text-md">National Institutional Ranking Framework Reports</h2>
    </div>
    
    <div class="grid-container">
      <a 
        v-for="(item, index) in nirfReports" 
        :key="item.year"
        :href="item.link" 
        target="_blank"
        class="report-card"
      ...
      >
        <div class="card-content">
          <span class="year-badge">CUK-NIRF</span>
  ...
  data() {
    return {
      nirfReports: [
        ...
        {
          year: '2024',
          link: 'https://cuk.ac.in/NIRF/NIRF2024.pdf'
        },
        {
          year: '2023',
          link: 'https://cuk.ac.in/NIRF/CUK-NIRF%202023.pdf'
        },
        {
          year: '2022',
          link: 'https://cuk.ac.in/NIRF/CUKNIRF2020-21.pdf'
        },
        {
          year: '2021',
          link: 'https://cuk.ac.in/NIRF/CUKNIRF2019-20.pdf'
        },
        {
          year: '2020',
          link: 'https://cuk.ac.in/Circular/CUK%20NIRF%20%202020.pdf'
        },
        {
          year: '2019',
          link: 'https://cuk.ac.in/Administration/pdf/NIRF%202019.pdf'
        },
        {
          year: '2018',
          link: 'https://cuk.ac.in/Administration/pdf/CUK%20%20NIRF%202018.pdf'
        },
        {
          year: '2017',
          link: 'https://cuk.ac.in/Administration/pdf/cuknirf2017.pdf'
        }
      ]
    };
  },
