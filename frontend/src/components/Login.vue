      ...
      <div class="form-content">
        ...
        <div class="input-group">
          ...
          <div class="input-container">
            ...
            <input v-model="email" type="email" placeholder="name@university.edu" class="input-field" required />
          </div>
        </div>
...
.input-field {
  @apply w-full px-4 py-3 bg-transparent text-gray-700 placeholder-gray-400 focus:outline-none;
}
...
.error-message {
  @apply flex items-center px-4 py-3 bg-red-50 text-red-700 rounded-lg border border-red-100 text-sm;
}
